...
public:
   ...
   DynamicRain
    ...
    /*
    * Calculate grid mapping index from model grid to rainfall grid for UCKP rainfall data
    */
    void UKCP_generate_index_grid
    (
        int grid_cols, int grid_rows, int grid_cols_padded, NUMERIC_TYPE blx, NUMERIC_TYPE tlx, NUMERIC_TYPE dx, int* rain_grid_ind
    );
